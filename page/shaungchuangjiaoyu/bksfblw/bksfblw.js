                    ...
                    ,done: function(res, curr, count){
                        ...
                        let active = {
                            search: function(){
                                other_table.reload({
                                    where: {
                                        'lwTitle': $(".other_search input[name='lwTitle']").val()
            ...
            var initEditForm = function (data) {
                ...
                let student_datatable = table.render({
                    ...
                    ,cols : [[ //表头
                        ...
                        ,{field: 'sorted', title: '排序', width:120, align:'center'}
                        ,{fixed: 'right', title: '操作', width:80, align:'center', toolbar: '#student_datatable_bar'}
                    ]]
                    ,even: true //隔行背景
                    ,done : function(res, curr, count) {
                ...
                let options = {
                    ...
                    ,success: function(layero, index){
                        ...
                        html = '<table class="layui-table">\n' +
                            '           <tbody>\n' +
                            '              <tr>' +
                            '                 <td style="width: 80px; text-align: right">论文题目：</td><td style="width: 120px;" colspan="3">'+data.lwTitle+'</td>' +
                            '              </tr>\n' +
                            '              <tr>' +
