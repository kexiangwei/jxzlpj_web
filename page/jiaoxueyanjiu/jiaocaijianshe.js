            ...
            if(data.isSubmit > 0){ //拥有提交权限
                ...
                var myself_table = table.render({
                    ...
                    ,cols : [[ //表头
                        ...
                        ,{field: 'peixunName', title: '教材名称', width:120}
                        ,{field: 'peixunStyle', title: '教材类别', width:120}
                        ,{field: 'peixunStartTime', title: '参与形式', width:120}
                        ,{field: 'peixunAddress', title: 'ISBN', width:120}
                        ,{field: 'peixunEndTime', title: '出版社', width:120}
                        ,{field: 'peixunAddress', title: '出版时间', width:120}
                        ,{field: 'peixunEndTime', title: '教材入选情况', width:120}
                        ,{field: 'peixunClassHour', title: '入选时间', width:120}
