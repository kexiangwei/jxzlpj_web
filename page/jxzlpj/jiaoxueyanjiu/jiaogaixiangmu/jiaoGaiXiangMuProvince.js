        ...
        ,success:function(data) {
            ...
            if(data.isAuthSubmit > 0){ //拥有提交权限
                ...
                var myself_table = table.render({
                    ...
                    ,elem : '#myself_table'
                    ,height : 500
                    ,url: requestUrl+'/jxyj_jgxm_province/getPageList.do'
                    ,where:{
                        "userId":function () {
                            return  $.cookie('userId');
                        }
                            ...
                            let layIndex = layer.open({
                                ...
                                ,success: function(layero, index){
                                    ...
                                    form.on('submit(toSubmitEidtForm)', function(data){
                                        $.post(requestUrl+'/jxyj_jgxm_province/insert.do' ,data.field ,function(result_data){
                ...
                table.on('tool(myself_table)', function(obj){
                    ...
                    if (obj.event === 'detail_dataInfo') {
                        ...
                        if(rowData.isSubmit=='未提交' && rowData.status !='退回'){
                            return;
                        }
                        detail_shenheProcess('教学研究-省部级教改项目-查看审核流程',rowData);
                        ...
                        let layIndex = layer.open({
                            ...
                            ,success: function(layero, index){
                                ...
                                //监听表单提交
                                form.on('submit(toSubmitEidtForm)', function(data){
                                    $.post(requestUrl+'/jxyj_jgxm_province/update.do' ,data.field ,function(result_data){
                                        layer.msg(result_data.msg, { offset: '100px'}, function () {
                                            layer.close(index);
                                        });
                                    },'json');
                        ...
                        layer.confirm('删除后不可恢复，真的要删除么？', {icon: 3, title:'提示', offset: '100px'}, function(index) {
                            $.post(requestUrl+'/jxyj_jgxm_province/delete.do', { "code": rowData.code},function(result_data){
                                layer.msg(result_data.msg, { offset: '100px'}, function () {
                    ...
                    ,success: function(layero, index){
                        ...
                        form.on('submit(toSubmitShenHeForm)', function(formData){
                            $.post(requestUrl+'/toShenhe.do',{
                                'viewName':'V_JXYJ_JGXM_PROVINCE_SHENHE'
