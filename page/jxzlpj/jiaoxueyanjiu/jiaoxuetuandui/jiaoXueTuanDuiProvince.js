        ...
        ,success:function(data) {
            ...
            if(data.isAuthSubmit > 0){ //拥有提交权限
                ...
                var myself_table = table.render({
                    ...
                    ,elem : '#myself_table'
                    ,height : 480
                    ,url: requestUrl+'/jxyj_jxtd_province/getPageList.do'
                    ,where:{
                        "userId":function () {
                            return $.cookie('userId');
                        },
                            ...
                            layer.open({
                                ...
                                ,success: function(layero, index){
                                    ...
                                    form.on('submit(toSubmitEidtForm)', function(data){
                                        ...
                                        $.post(requestUrl+'/jxyj_jxtd_province/insert.do',formData,function(result_data){
                ...
                table.on('tool(myself_table)', function(obj){
                    ...
                    if (obj.event === 'detail_dataInfo') {
                        ...
                        detail_shenheProcess('教学研究-教学团队-省部级团队-查看审核流程',rowData);
                        ...
                        layer.open({
                            ...
                            ,success: function(layero, index){
                                ...
                                form.on('submit(toSubmitEidtForm)', function(data){
                                    let formData = data.field;
                                    // alert(JSON.stringify(formData));
                                    $.post(requestUrl+'/jxyj_jxtd_province/update.do', formData, function(result_data){
                                        layer.msg(result_data.msg, { offset: '100px'}, function () {
                                            layer.close(index);
                                        });
                                    },'json');
                        ...
                        layer.confirm('删除后不可恢复，真的要删除么？', {icon: 3, title:'提示', offset: '100px'}, function(index) {
                            $.post(requestUrl+'/jxyj_jxtd_province/delete.do', { code: rowData.code},function(result_data){
                                layer.msg(result_data.msg, { offset: '100px'}, function () {
                    ...
                    ,success: function(layero, index){
                        ...
                        form.on('submit(toSubmitShenHeForm)', function(formData){
                            $.post(requestUrl+'/toShenhe.do',{
                                'viewName':'v_jxyj_jxtd_province_shenhe'
            ...
            let detail_zjsh = function (row_data) {
                ...
                layer.open({
                    title : '教学研究-教学团队-省部级团队-查看专家审核意见'
                    ,type : 1
                    ,area : [ '900px', '450px' ]
