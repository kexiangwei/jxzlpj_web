            ...
            if(data.isAuthSubmit > 0){ //拥有提交权限
                ...
                table.on('tool(myself_table)', function(obj){
                    ...
                    if (obj.event === 'detail_dataInfo') {
                        ...
                        detail_shenheProcess('教学研究-教学团队-校级团队-查看审核流程',rowData);
            ...
            if(data.isAuthShenhe > 0){ //拥有审核权限
                ...
                table.on('tool(other_table)', function(obj){
                    ...
                    if (obj.event === 'detail_dataInfo') {
                        ...
                        detail_shenheProcess('教学研究-教学团队-校级团队-查看审核流程',data);
                ...
                let options = {
                    ...
                    ,success: function(layero, index){
                        ...
                        $.get(requestUrl+"/getFileListByRelationCode.do" , {
                            ...
                            let nulltr = '<tr><td colspan="3" style="text-align: center;">无数据</td></tr>';
                            if(result_data.data.length ===0){
                                fileList.append(nulltr);
                                fileList2.append(nulltr);
                            } else {
                                let fileListNum = 0
                                    ,fileListNum2 = 0;
                                $.each(result_data.data,function(index,fileInfo){
                                    ...
                                    if(fileInfo.fileType === 'sbs'){
                                        fileListNum++;
                                        fileList.append(tr);
                                    }
                                    if(fileInfo.fileType === 'ndkhbg'){
                                        fileListNum2++;
                                        fileList2.append(tr);
                                    }
                                });
