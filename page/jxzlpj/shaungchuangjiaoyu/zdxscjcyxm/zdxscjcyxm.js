            ...
            if(data.isAuthSubmit > 0){ //拥有提交权限
                ...
                table.on('tool(myself_table)', function(obj){
                    ...
                    if (obj.event === 'detail_dataInfo') {
                        ...
                        detail_shenheProcess('双创教育-指导学生参加创业项目-查看审核流程',data);
            ...
            if(data.isAuthShenhe > 0){ //拥有审核权限
                ...
                table.on('tool(other_table)', function(obj){
                    ...
                    if (layEvent === 'detail_dataInfo') {
                        ...
                        detail_shenheProcess('双创教育-指导学生参加创业项目-查看审核流程',rowData);
                    }
                });
                ...
                let options = {
                    ...
                    ,success: function(layero, index){
                        ...
                        html = '<table class="layui-table">\n' +
                            ...
                            '              </tr>\n' +
                            '              <tr>' +
                            '                <td style="width: 80px; text-align: right">项目级别：</td><td style="width: 120px;">'+data.level1+'</td>' +
