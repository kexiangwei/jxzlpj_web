            ...
            if(data.isSubmit > 0){ //拥有提交权限
                ...
                var myself_table = table.render({
                    ...
                    ,cols : [[ //表头
                        ...
                        ,{field: 'level_1', title: '奖项级别', width:120}
                                    ...
                                    let layerIndex = layer.open({
                                        ...
                                        ,success: function(layero, index){
                                            ...
                                            form.on('submit(editFormSubmitBtn)', function(data){
                                                 ...
                                                 return false;*/
                                                $.post(requestUrl+'/jxjl/insert.do',{
                            ...
                            if (obj.event === 'detail_dataInfo') {
                                ...
                                let layerIndex = layer.open({
                                    ...
                                    ,success: function(layero, index){
                                        ...
                                        //监听表单提交
                                        form.on('submit(editFormSubmitBtn)', function(data){
                                            $.post(requestUrl+'/jxjl/update.do',{
                                                "code":data.field.code
                                                ,"userId": data.field.userId
                                                ,"userName": data.field.userName
                                                ,"objName" : data.field.objName
                ...
                let options = {
                    ...
                    ,success: function(layero, index){
                        ...
                        let htmlStr = '<table class="layui-table">\n' +
                            ...
                            '              </tr>\n' +
                            '              <tr>' +
                            '                <td style="width: 80px; text-align: right">奖项级别：</td><td style="width: 120px;">'+data.level_1+'</td>' +
