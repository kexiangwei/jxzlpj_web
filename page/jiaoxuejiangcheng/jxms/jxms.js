            ...
            if(data.isSubmit > 0){ //拥有提交权限
                ...
                var myself_table = table.render({
                    ...
                    ,cols : [[ //表头
                        ...
                        ,{field: 'awardDate', title: '获奖日期', width:150}
                                    ...
                                    let layerIndex = layer.open({
                                        ...
                                        ,success: function(layero, index){
                                            ...
                                            form.on('submit(editFormSubmitBtn)', function(data){
                                                 ...
                                                 return false;*/
                                                $.post(requestUrl+'/jxms/insert.do',{
                            ...
                            if (obj.event === 'detail_dataInfo') {
                                ...
                                let layerIndex = layer.open({
                                    ...
                                    ,success: function(layero, index){
                                        ...
                                        //监听表单提交
                                        form.on('submit(editFormSubmitBtn)', function(data){
                                            $.post(requestUrl+'/jxms/update.do',{
                                                "code":data.field.code
                                                ,"userId": data.field.userId
                                                ,"userName": data.field.userName
                                                ,"level_1" : data.field.level_1
                ...
                let options = {
                    ...
                    ,success: function(layero, index){
                        ...
                        let htmlStr = '<table class="layui-table">\n' +
                            ...
                            '              </tr>\n' +
                            '              <tr>' +
                            '                 <td style="width: 80px; text-align: right">级别：</td><td style="width: 120px;" colspan="3">'+data.level_1+'</td>' +
                            '              </tr>\n' +
                            '              <tr>' +
