            ...
            if(data.isSubmit > 0){ //拥有提交权限
                ...
                var myself_table = table.render({
                    ...
                    ,cols : [[ //表头
                        ...
                        ,{field: 'peixunName', title: '课程名称', width:120}
                        ,{field: 'peixunStyle', title: '上课时间', width:120}
                        ,{field: 'peixunStartTime', title: '节次', width:120}
                        ,{field: 'peixunEndTime', title: '课题', width:120}
                        ,{field: 'peixunClassHour', title: '时数', width:120, sort:true, totalRow:true}
