        ...
        ,success:function(data) {
            ...
            if(data.isSubmit > 0){ //拥有提交权限
                ...
                var myself_table = table.render({
                    ...
                    ,height : 440
                    ,id: "myself_table_id"
                    ,url: requestUrl+'/kcssjh/getPageList.do'
                    ,where:{
                        "userId":function () {
                            return  $.cookie('userId');
                        }
                            ...
                            let layIndex = layer.open({
                                ...
                                ,success: function(layero, index){
                                    ...
                                    form.on('submit(toSubmitEidtForm)', function(data){
                                        $.post(requestUrl+'/kcssjh/insert.do' ,data.field ,function(result_data){
                ...
                table.on('tool(myself_table)', function(obj){
                    ...
                    if (obj.event === 'detail_dataInfo') {
                        ...
                        detail_shenheProcess('教学设计-课程实施计划-查看审核流程',data);
                        ...
                        layer.open({
                            ...
                            ,success: function(layero, index){
                                ...
                                //监听表单提交
                                form.on('submit(toSubmitEidtForm)', function(data){
                                    $.post(requestUrl+'/kcssjh/update.do' ,data.field ,function(result_data){
                        ...
                        layer.confirm('删除后不可恢复，真的要删除么？', {icon: 3, title:'提示', offset: '100px'}, function(index) {
                            $.post(requestUrl+'/kcssjh/delete.do', { 'code': data.code},function(result_data){
            ...
            var toSubmit = function (row_dataArr){
                layer.confirm('信息提交后不可进行编辑、删除操作，是否继续提交？', {icon: 3, title:'提示', offset: '100px'}, function(index) {
                    $.post(requestUrl+'/kcssjh/toSubimt.do',{
                ...
                layer.open({
                    ...
                    ,success: function(layero, index){
                        ...
                        form.on('submit(toSubmitShenHeForm)', function(formData){
                            $.post(requestUrl+'/kcssjh/toShenhe.do',{
                                "jsonStr":JSON.stringify(row_dataArr)
