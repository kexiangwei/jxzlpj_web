            ...
            if(data.isSubmit > 0){ //拥有提交权限
                ...
                var myself_table = table.render({
                    ...
                    ,cols : [[ //表头
                        ...
                        ,{field:'code', title:'学年', width:120, sort: true}
                        ,{field: 'peixunName', title: '课程编号', width:120}
                        ,{field: 'peixunStyle', title: '课程名称', width:120}
                        ,{field: 'peixunStartTime', title: '授课班级', width:120}
                        ,{field: 'peixunEndTime', title: '总学时', width:120}
